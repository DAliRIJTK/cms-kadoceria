    ...
    <form method="GET" action="{{ route('dashboard') }}" class="bg-white rounded-lg shadow-sm p-4">
        <div class="grid grid-cols-1 md:grid-cols-5 gap-4 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('dashboard') }}" class="flex-1 bg-gray-300 hover:bg-gray-400 text-gray-800 px-4 py-2 rounded-lg transition-colors duration-200 font-medium text-center">
                    Reset
                </a>
            </div>
        </div>
