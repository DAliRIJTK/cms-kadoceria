...
@if($buku->halaman()->count() === 0)
        {{-- Pengunci layar instan (tanpa jeda JavaScript) --}}
        <div class="fixed inset-0 z-[9999] bg-gray-900/80 backdrop-blur-sm flex items-center justify-center">
            <div class="bg-white rounded-2xl shadow-2xl px-16 py-12 flex flex-col items-center gap-6 max-w-sm text-center">
                <svg class="animate-spin w-16 h-16 text-blue-600" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <div>
                    <h3 class="text-xl font-bold text-gray-900 mb-2">Memproses PDF</h3>
                    <p class="text-sm text-gray-500">Sistem sedang mengonversi halaman. Mohon jangan tutup atau kembali dari halaman ini.</p>
                </div>
            </div>
        </div>
        <script>
            // Polling otomatis setiap 4 detik tanpa mempedulikan DOMContentLoaded
